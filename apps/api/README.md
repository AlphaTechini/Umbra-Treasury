...
The API does not implement full authentication yet. Wallet addresses are accepted as identity inputs for the MVP workflow, which is enough for the frontend demo but should be replaced with signed wallet authentication before production use.
